...
var ListasComponent = /** @class */ (function () {
    function ListasComponent(deseoService, router, alerCtrl) {
    ...
    ListasComponent.prototype.elimnarLista = function (lista) {
    ...
    __decorate([
        core_1.Input()
    ], ListasComponent.prototype, "tareaterminada");
    __decorate([
        core_1.ViewChild(angular_1.IonList)
    ], ListasComponent.prototype, "lista");
